...
describe('computeStageBars', () => {
  it('returns exactly 5 geometries in canonical stage order', () => {
    const bars = computeStageBars(windowMonth, MINI_TEAM_FEATURE, FIXTURE_TODAY);
  ...
  it('produces ghost geometries for an all-unplanned feature', () => {
    const bars = computeStageBars(windowMonth, UNSCHEDULED_FEATURE, FIXTURE_TODAY);
  ...
  it('produces ghost geometry for individually-unplanned stages in a partial plan', () => {
    ...
    const bars = computeStageBars(windowMonth, OVERDUE_FEATURE, FIXTURE_TODAY);
  ...
  it('treats LiveRelease feature as fully completed — no overdue', () => {
    const bars = computeStageBars(windowMonth, SHIPPED_FEATURE, FIXTURE_TODAY);
