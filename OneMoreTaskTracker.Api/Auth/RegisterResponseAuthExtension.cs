...
// Bridges proto-generated RegisterResponse to the domain IAuthUserContext per
// ~/.claude/rules/microservices/contracts.md (no transport types in domain).
...
public partial class RegisterResponse : IAuthUserContext
{
